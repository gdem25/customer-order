...
namespace CustomerOrderBack
{
    public class JwtHandler
    {
        private readonly IConfiguration _configuration;
        private readonly UserManager<CustomerOrderUser> _userManager;
        public JwtHandler(IConfiguration configuration, UserManager<CustomerOrderUser> userManager)
        {
            _configuration = configuration;
            _userManager = userManager;
        }

        public async Task<JwtSecurityToken> GetTokenAsync(CustomerOrderUser user) =>
        new(
        ...
        private async Task<List<Claim>> GetClaimsAsync(CustomerOrderUser user)
        {
